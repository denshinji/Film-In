...
public class SearchMovie implements Parcelable {
    ...
    public SearchMovie(String desc, String title, String imageurl, String daterelease, String backdrop, String languange, String vote, String popularity, Integer id, String rate) {
        this.desc = desc;
        this.title = title;
